...
export const ProtectedApiRoutes = [
  ...
  "POST /api/v1/agent/export-diagnostics",
  "POST /api/v1/agent/self-test",
...
export const RoutePermissions: RoutePermission[] = [
  ...
  { route: "POST /api/v1/agent/export-diagnostics", permission: "manage_agent" },
  { route: "POST /api/v1/agent/self-test", permission: "manage_agent" },
